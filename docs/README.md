...
Start at [AGENTS.md](../AGENTS.md). In an AI outage, this index is your map.

| Need | Go to |
|---|---|
| Orientation — what this project is | [AGENTS.md](../AGENTS.md) |
...
| Learn LangGraph vocabulary | [../LEARNING.md](../LEARNING.md) |
| Run the evaluation suite | [../evals/README.md](../evals/README.md) |
| Why was X decided | [adr/](adr/) |
| Propose future work | [proposals/](proposals/) |
| Do a common task | [skills/](skills/) |
