...
| [0004](0004-host-mcp-server-on-aws-postgres.md) | Host the MCP server on AWS with Postgres-backed state | Accepted · platform → GCP; worker split → 0005 |
| [0005](0005-worker-split-cloud-tasks.md) | Durable job queue (worker split) via Cloud Tasks | Accepted |
